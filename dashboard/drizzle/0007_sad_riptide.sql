...
CREATE TABLE `__new_daily_source_records` (
	...
	CONSTRAINT "ck_daily_source_records_respiratory_rate" CHECK("respiratory_rate" IS NULL OR "respiratory_rate" > 0),
	CONSTRAINT "ck_daily_source_records_skin_temperature" CHECK("skin_temperature_c" IS NULL OR "skin_temperature_c" > 0),
