...
export function createTestDatabase() {
  ...
  for (const migration of ["0000_silent_hulk.sql", "0001_ambitious_master_chief.sql", "0002_yielding_doctor_spectrum.sql", "0003_tan_wrecker.sql", "0004_remove_jackie_household.sql", "0005_goofy_the_santerians.sql", "0006_fluffy_rocket_raccoon.sql", "0007_sad_riptide.sql", "0008_cold_salo.sql", "0009_modern_absorbing_man.sql"]) {
